...
# def work_with_phonebook():              #Основная функция, которую мы вызываем

#     choice=show_menu()                  # Вызываем меню

#     phone_book = read_txt('phonebook.txt')  # Тот файл, куда мы вписываем новые данные. Находится в той же директории. где основной файл
    
#     while (choice!=7):                # Выбор из меню. 
...
#         choice=show_menu()          # В конце цикла, программа будет ждать от нас выбора следующей функции
...
#           '6. Добавить абонента в справоник'
...
#     fields=['Фамилия', 'Имя', 'Телефон', 'Описание']     # Оглавление

# with open(filename, 'r', encoding='utf-8') as phb:       # Открывает файл для чтения
#     for line in phb:
#         record = dict(zip(fields,   line.split(,)))      # record   -   Список словарей
#         data.appened(record)
# return phone_book
